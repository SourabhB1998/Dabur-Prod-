(function(c) {
    ...
    k(c, "mixins/download-url.js", [ c["parts/Globals.js"] ], function(b) {
        ...
        b.dataURLtoBlob = function(b) {
            if ((b = b.match(/data:([^;]*)(;base64)?,([0-9A-Za-z+/]+)/)) && 3 < b.length && a.atob && a.ArrayBuffer && a.Uint8Array && a.Blob && k.createObjectURL) {
                var d = a.atob(b[3]), c = new a.ArrayBuffer(d.length);
        ...
        b.downloadURL = function(d, k) {
            ...
            if ("string" === typeof d || d instanceof String || !c.msSaveOrOpenBlob) {
                if (v || 2e6 < d.length) if (d = b.dataURLtoBlob(d), !d) throw Error("Failed to convert to blob");
                if ("undefined" !== typeof e.download) e.href = d, e.download = k, u.body.appendChild(e), 
                e.click(), u.body.removeChild(e); else try {
    ...
    k(c, "modules/export-data.src.js", [ c["parts/Globals.js"], c["parts/Utilities.js"] ], function(b, a) {
        function c(a, b) {
            var c = d.navigator, m = -1 < c.userAgent.indexOf("WebKit") && 0 > c.userAgent.indexOf("Chrome"), e = d.URL || d.webkitURL || d;
            try {
        ...
        var k = a.defined, F = a.extend, v = a.pick, d = b.win, A = d.document, e = b.seriesTypes, f = b.downloadURL, z = b.fireEvent;
        b.setOptions({
            exporting: {
                csv: {
        ...
        b.Chart.prototype.getDataRows = function(a) {
            var c = this.hasParallelCoordinates, d = this.time, e = this.options.exporting && this.options.exporting.csv || {}, m = this.xAxis, p = {}, f = [], B = [], w = [], r, C = function(h, c, d) {
            ...
            this.series.forEach(function(h) {
                var t = h.options.keys || h.pointArrayMap || [ "y" ], q = t.length, l = !h.requireSorting && {}, k = m.indexOf(h.xAxis), f = D(h, t), n;
                if (!1 !== h.options.includeInDataExport && !h.options.isInternal && !1 !== h.visible) {
                    b.find(g, function(a) {
                        return a[0] === k;
                    }) || g.push([ k, y ]);
                  
                    for (n = 0; n < q; ) r = C(h, t[n], t.length), w.push(r.columnTitle || r), a && B.push(r.topLevelColumnTitle || r), 
                    n++;
                    ...
                    h.options.data.forEach(function(a, b) {
                        ...
                        if(a === 0){
                            ...
                            a = a.target != undefined ? a.target : a;
                        ...
                        for (p[a].xValues[k] = g.x; n < q; ) b = t[n], m = g[b], p[a][y + n] = v(f.categoryMap[b][m], f.dateTimeValueAxisMap[b] ? d.dateFormat(e.dateFormat, m) : null, m), 
                        n++;
            ...
            for (y = g.length; y--; ) {
                ...
                f.forEach(function(a) {
                    var b = a.name;
                    x && !k(b) && (x.isDatetimeAxis ? (a.x instanceof Date && (a.x = a.x.getTime()), 
                    b = d.dateFormat(e.dateFormat, a.x)) : b = x.categories ? v(x.names[a.x], x.categories[a.x], a.x) : a.x);
                    a.splice(l, 0, b);
                });
            }
            q = q.concat(f);
        ...
        b.Chart.prototype.getCSV = function(a) {
            var b = "", c = this.getDataRows(), d = this.options.exporting.csv, e = v(d.decimalPoint, "," !== d.itemDelimiter && a ? 1.1.toLocaleString()[1] : "."), m = v(d.itemDelimiter, "," === e ? ";" : ","), k = d.lineDelimiter;
            c.forEach(function(a, d) {
                for (var f, n = a.length; n--; ) f = a[n], "string" === typeof f && (f = '"' + f + '"'), 
                "number" === typeof f && "." !== e && (f = f.toString().replace(".", e)), a[n] = f;
                b += a.join(m);
                d < c.length - 1 && (b += k);
            });
            return b;
        ...
        b.Chart.prototype.getTable = function(a) {
            var b = '<table id="highcharts-data-table-' + this.index + '">', c = this.options, d = a ? 1.1.toLocaleString()[1] : ".", e = v(c.exporting.useMultiLevelHeaders, !0);
            a = this.getDataRows(e);
            var f = 0, k = e ? a.shift() : null, m = a.shift(), w = function(a, b, c, e) {
                var g = v(e, "");
                b = "text" + (b ? " " + b : "");
                "number" === typeof g ? (g = g.toString(), "," === d && (g = g.replace(".", d)), 
                b = "number") : e || (b = "empty");
                return "<" + a + (c ? " " + c : "") + ' class="' + b + '">' + g + "</" + a + ">";
            };
            !1 !== c.exporting.tableCaption && (b += '<caption class="highcharts-table-caption">' + v(c.exporting.tableCaption, c.title.text ? c.title.text.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;") : "Chart") + "</caption>");
            ...
            b += function(a, b, d) {
                ...
                if (l) {
                    for (f += "<tr>"; g < d; ++g) {
                        l = a[g];
                        var m = a[g + 1];
                        l === m ? ++k : k ? (f += w("th", "highcharts-table-topheading", 'scope="col" colspan="' + (k + 1) + '"', l), 
                        k = 0) : (l === b[g] ? c.exporting.useRowspanHeaders ? (m = 2, delete b[g]) : (m = 1, 
                        b[g] = "") : m = 1, f += w("th", "highcharts-table-topheading", 'scope="col"' + (1 < m ? ' valign="top" rowspan="' + m + '"' : ""), l));
                    }
                    f += "</tr>";
                }
                if (b) {
        ...
        b.Chart.prototype.viewData = function() {
            this.dataTableDiv || (this.dataTableDiv = A.createElement("div"), this.dataTableDiv.className = "highcharts-data-table", 
        ...
        if (a = b.getOptions().exporting) F(a.menuItemDefinitions, {
            downloadCSV: {
                textKey: "downloadCSV",
                onclick: function() {
                    this.downloadCSV();
        ...
        e.treemap && (e.treemap.prototype.exportKey = "name");
    });
